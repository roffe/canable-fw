...
static uint32_t seg1;
static uint32_t seg2;
static uint32_t sjw;
...
void can_enable(void)
{
    if (bus_state == OFF_BUS)
    {
        ...
        can_handle.Init.SyncJumpWidth = sjw;
        can_handle.Init.TimeSeg1 = seg1;
        can_handle.Init.TimeSeg2 = seg2;
...
void can_set_bitrate(enum can_bitrate bitrate)
{
    ...
    // defaults for “normal” bitrates: 8 TQ total (1 + 4 + 3)
    uint32_t tmp_prescaler = prescaler;
    uint32_t tmp_seg1 = CAN_BS1_4TQ;
    uint32_t tmp_seg2 = CAN_BS2_3TQ;
    uint32_t tmp_sjw = CAN_SJW_1TQ;
    ...
    case CAN_BITRATE_1000K:
        prescaler = 6;
        break;
    case CAN_BITRATE_615K:
        // Custom 615.384 kbit/s:
        // total TQ = 1 + 8 + 4 = 13
        // Prescaler = 6  -> exact 615384.615 bps at 48MHz
        tmp_prescaler = 6;
        tmp_seg1 = CAN_BS1_8TQ;
        tmp_seg2 = CAN_BS2_4TQ;
        tmp_sjw = CAN_SJW_2TQ;
        break;
